...
console.log(checkPhoneNumber('+1 099-999-9999')); 
console.log(checkPhoneNumber('+1 (099)-999-9999')); 
console.log(checkPhoneNumber('+1 (099)9999999')); 
console.log(checkPhoneNumber('+1 099 999 9999')); 
console.log(checkPhoneNumber('+1 099 999-9999')); 
console.log(checkPhoneNumber('+1 (099) 999-9999')); 
console.log(checkPhoneNumber('+1 099.999.9999')); 

console.log(checkPhoneNumber('+1 099-9999')); 
console.log(checkPhoneNumber('0999999999')); 
